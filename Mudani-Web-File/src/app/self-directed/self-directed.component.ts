...
@Component({
  selector: 'app-self-directed',
  templateUrl: './self-directed.component.html',
  styleUrls: ['./self-directed.component.scss']
})
export class SelfDirectedComponent implements OnInit {
